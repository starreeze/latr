# copied from https://github.com/Jiayi-Pan/TinyZero/blob/main/examples/data_preprocess/countdown.py
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dst", default="dataset/countdown")
    ...
    raw_dataset = cast(Dataset, load_dataset(args.src, split="train"))
